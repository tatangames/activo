                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label>Código</label>
                                        <input type="text" maxlength="50" class="form-control" id="codigo-nuevo">
                                    </div>

                                    <div class="form-group">
                                        <label>Nombre</label>
                                        <input type="text" maxlength="300" class="form-control" id="nombre-nuevo">
                                    </div>
...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var ruta = "{{ URL::to('/admin/departamento/tabla') }}";
    ...
    <script>
        ...
        function recargar(){
            var ruta = "{{ url('/admin/departamento/tabla') }}";
            $('#tablaDatatable').load(ruta);
        }
        ...
        function nuevo(){
            ...
            if(codigo.length > 50){
                toastr.error('código máximo 50 caracteres');
                return;
            }
            ...
            axios.post(url+'/departamento/informacion',{
                ...
                .then((response) => {
                    ...
                    if(response.data.success === 1){
                        ...
                        $('#codigo-editar').val(response.data.departamento.codigo);
