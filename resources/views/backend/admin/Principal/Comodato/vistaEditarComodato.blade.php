            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <p class="breadcrumb-item">Comodato</p>
...
@section('archivos-js')
    ...
    <script type="text/javascript">
        ...
        window.idGlobalBienComodatoEditar = {{ $idbien }};
        ...
        $('#descripcion').keyup(function(){
            ...
            if(tipo == '1'){
                if(query != ''){
                    axios.post(url+'/comodato/buscar/bien/mueble', {
                        'query' : query
                    })
                        .then((response) => {
                ...
                if(query != ''){
                    axios.post(url+'/comodato/buscar/bien/inmueble', {
                        'query' : query
                    })
                        .then((response) => {
                ...
                if(query != ''){
                    axios.post(url+'/comodato/buscar/bien/maquinaria', {
                        'query' : query
                    })
                        .then((response) => {
    ...
    <script>
        ...
        function guardar(){
            ...
            formData.append('idbien', idGlobalBienComodatoEditar); // id del bien

            axios.post(url+'/comodato/editar', formData, {
            })
                .then((response) => {
                    closeLoading();
        ...
        function actualizar(){
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href="{{ url('/admin/comodato/index') }}";
                }
            });
        }
