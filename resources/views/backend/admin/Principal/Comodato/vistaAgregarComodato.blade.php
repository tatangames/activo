...
@section('archivos-js')
    ...
    <script>
        ...
        function guardar(){
            ...
            formData.append('id', idGlobalBienComodato);

            axios.post(url+'/comodato/nuevo', formData, {
            })
                .then((response) => {
