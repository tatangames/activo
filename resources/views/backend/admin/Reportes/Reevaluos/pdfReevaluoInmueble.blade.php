...
<h2 style="text-align: center; font-size: 19px">Reevaluos realizadas desde: {{ $f1 }} hasta {{ $f2 }} <br> <br> Bienes Inmuebles </h2>
@if($haydatos == false)
...
@else
    ...
    <div id="content">
        <table id="tabla" style="table-layout:fixed;">
            <thead class="corte">
            <tr>
                <th style="text-align: center; color: black; font-size:15px; width: 9%">Código</th>
                <th style="text-align: center; color: black; font-size:15px; width: 38%">Descripción</th>
                <th style="text-align: center; color: black; font-size:15px; width: 11%">Valor</th>
                <th style="text-align: center; color: black; font-size:15px; width: 11%">Valor Reevaluo</th>
                <th style="text-align: center; color: black; font-size:15px; width: 9%">Fecha</th>
            </tr>
            </thead>
            ...
            @foreach($lista as $item)
                <tr>
                    ...
                    <td style="text-align: center">{{ $item->valornuevo }}</td>
