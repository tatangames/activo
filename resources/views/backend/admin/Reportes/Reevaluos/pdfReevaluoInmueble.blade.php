...
<h2 style="text-align: center; font-size: 16px">Reevaluos realizadas desde: {{ $f1 }} hasta {{ $f2 }} <br> <br> Bienes Inmuebles </h2>
@if($haydatos == false)
        ...
        <table id="tabla" style="width: 95%; table-layout:fixed;">
            ...
            @foreach($lista as $item)
                <tr>
                    ...
                    <td style="font-size:13px; text-align: left">{{ $item->valor }}</td>
                    <td style="font-size:13px; text-align: center">{{ $item->valornuevo }}</td>
