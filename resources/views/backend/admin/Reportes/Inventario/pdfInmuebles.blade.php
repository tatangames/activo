...
<h2 style="text-align: center; font-size: 19px"> Bienes Inmuebles Municipales </h2>
@if($haydatos == false)
        ...
        <table id="tabla" style="table-layout:fixed;">
            ...
            @foreach($lista as $item)
                <tr>
                    ...
                    <td style="text-align: center">{{ $item->inscrito }}</td>
                    <td style="text-align: left">{{ $item->fechacompra }}</td>
                    <td style="text-align: center">{{ $item->edificaciones }}</td>
