...
<h2 style="text-align: center; font-size: 16px"> Bienes Inmuebles Municipales </h2>
@if($haydatos == false)
...
@else
    ...
    <div id="content">
        <table id="tabla" style="width: 95%; margin-top: 30px; margin-bottom: 35px" >
            <thead>
            <tr>
                <th style="text-align: center; color: black; font-size:15px; width: 8%">Nº</th>
                <th style="text-align: center; color: black; font-size:15px; width: 20%">Descripción</th>
                <th style="text-align: center; color: black; font-size:15px; width: 12%"># CNR</th>
                <th style="text-align: center; color: black; font-size:15px; width: 12%">Fecha de Compra</th>
                <th style="text-align: center; color: black; font-size:15px; width: 12%">Edificaciones</th>
                <th style="text-align: center; color: black; font-size:15px; width: 12%">Valor de escritura</th>
            </tr>
            </thead>
            ...
            @foreach($lista as $item)
                <tr>
                    ...
                    <td style="font-size:13px; text-align: center">{{ $item->inscrito }}</td>
                    <td style="font-size:13px; text-align: left">{{ $item->fechacompra }}</td>
                    <td style="font-size:13px; text-align: center">{{ $item->edificaciones }}</td>
            ...
            <tr>
                <td style="font-size:13px; text-align: center; font-weight: bold" colspan="5">Total</td>
