...
<h2 style="text-align: center; font-size: 16px"> Vehiculos Municipales Livianos y Pesados </h2>
@if($haydatos == false)
...
@else
    ...
    <div id="content">
        <table id="tabla" style="width: 95%; margin-top: 30px; margin-bottom: 35px" >
            <thead>
            <tr>
                <th style="text-align: center; color: black; font-size:15px; width: 8%">Nº de Mueble</th>
                ...
                <th style="text-align: center; color: black; font-size:15px; width: 12%">Valor</th>
            </tr>
            </thead>
