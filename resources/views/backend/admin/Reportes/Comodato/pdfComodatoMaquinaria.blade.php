...
<h2 style="text-align: center; font-size: 19px">Comodatos realizadas desde: {{ $f1 }} hasta {{ $f2 }} <br> <br> Bienes Vehículos y Maquinaria </h2>
@if($haydatos == false)
        ...
        <table id="tabla" style="table-layout:fixed;">
            ...
            @foreach($lista as $item)
                <tr>
                    ...
                    <td style="text-align: center">{{ $item->institucion }}</td>
