                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" maxlength="9" id="codigo" value="{{ $info->codigo }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea type="text" class="form-control" maxlength="5000" id="descripcion" rows="2" cols="50">{{ $info->descripcion }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control" value="{{ $info->valor }}" maxlength="9" id="valor">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea type="text" class="form-control" maxlength="1000" id="ubicacion" rows="2" cols="50">{{ $info->ubicacion }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" value="{{ $info->inscrito }}" maxlength="100" id="inscrito">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" maxlength="9" class="form-control" value="{{ $info->valorregistrado }}" id="valorregistrado">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea type="text" class="form-control" maxlength="2000" id="observaciones" rows="2" cols="50">{{ $info->observaciones }}</textarea>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea type="text" class="form-control" maxlength="800" id="contiene" rows="2" cols="50">{{ $info->contiene }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" maxlength="9" value="{{$info->edificaciones}}" class="form-control" id="edificaciones">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="date" class="form-control" value="{{$info->fechapermuta}}" id="fechapermuta">
                                            </div>
                                        </div>
...
@section('archivos-js')
    ...
    <script>
        ...
        function actualizarRegistro(){
            ...
            axios.post(url+'/bienes/inmuebles/editar', formData, {
            })
                .then((response) => {
                    closeLoading();
